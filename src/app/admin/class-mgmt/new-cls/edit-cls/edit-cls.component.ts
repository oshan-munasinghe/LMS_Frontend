...
@Component({
  selector: 'app-edit-cls',
  templateUrl: './edit-cls.component.html',
  styleUrls: ['./edit-cls.component.css'],
...
export class EditClsComponent implements OnInit {
  ...
  constructor(private formBuilder:FormBuilder,
    private messageService: MessageService, private Arouter:ActivatedRoute,private _CLS:classesService) { 
